...
public class UnityChan2DController : MonoBehaviour {
    ...
    public AudioClip Jump1 = null;
    public AudioClip Jump2 = null;
    public short RemainHP = 9;
    //
    ...
    //Add
    private AudioSource _AuidoSource = null;
    //
    ...
    public void Move (float move, bool jump) {
        ...
        if (jump && m_isGround) {
            ...
            _AuidoSource.PlayOneShot (RandomJumpSound ());
        }
    }
    ...
    IEnumerator INTERNAL_OnDamage () {
        ...
        //ADD
        _AuidoSource.PlayOneShot (Damage);
        GameObject Controller = GameObject.Find ("GameController");
        Controller.GetComponent<HPController> ().GetDamage ();
        RemainHP--;
        if(RemainHP<0){
